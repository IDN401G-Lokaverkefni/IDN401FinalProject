...
\usepackage{color}
\usepackage{amssymb, 
    amstext, amsmath, epstopdf, booktabs, verbatim, gensymb, geometry, appendix, natbib, lmodern}
...
\newcommand*\Title{Próftöflubestun}
\newcommand*\cpiType{IÐN401G - Aðgerðargreining}
\newcommand*\Date{Vormisseri 2016}
\newcommand*\Author{\textbf{Höfundar}:
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 170mm]{./myndir/graf3}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 170mm]{./myndir/graf4}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 170mm]{./myndir/graf5}
...
\subsection{Færsla stærri námskeiða}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 170mm]{./myndir/graf6}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 165mm]{./myndir/graf7}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 170mm]{./myndir/graf8}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 170mm]{./myndir/graf9}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 170mm]{./myndir/graf10}
